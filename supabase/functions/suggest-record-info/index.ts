...
3. Le TITRE de l'album/single : retrouve le titre OFFICIEL exact de cette sortie dans la discographie de l'artiste, puis compare mot à mot avec le titre saisi. Corrige tout écart : orthographe, singulier/pluriel (ex: "Photos de Voyage" -> "Photos de voyages" pour FRANCIS CABREL), accents, apostrophes, et surtout les MOTS EN TROP ou MANQUANTS au début ou à la fin (ex: "Un samedi soir sur la terre" -> "Samedi soir sur la terre" pour FRANCIS CABREL, car le titre officiel ne contient pas "Un"). Ne conserve jamais un article ajouté à tort. Respecte la graphie officielle réelle de l'album (ne force pas une majuscule à chaque mot si le titre officiel n'en a pas). Si tu n'es pas sûr du titre officiel, retourne null pour le titre.
