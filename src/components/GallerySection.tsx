  ...
  const content = (
    <>
      <img
        ...
        loading="lazy"
      />
      <div className={`absolute inset-0 transition-all duration-500 flex items-end p-6 ${item.alwaysShow ? "bg-background/40" : "bg-background/0 group-hover:bg-background/80"}`}>
